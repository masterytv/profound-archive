        ...
        <>
            ...
            {!isOpen && (
                <button
                    ...
                    className="fixed bottom-6 right-6 z-[9999] flex items-center gap-2 px-6 py-3.5
                    ...
                    <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4 scrollbar-thin">
                        {messages.length === 0 ? (
                            ...
                            <div className="flex flex-col gap-4 pt-2">
                                ...
                                <div className="flex gap-2.5">
                                    ...
                                    <div className="bg-white/10 rounded-xl rounded-tl-sm px-3.5 py-2.5 max-w-[85%]">
                                        ...
                                        <div className="flex gap-2 mt-2 opacity-50">
                                            <ThumbsUp className="w-3.5 h-3.5 cursor-pointer hover:opacity-100 transition-opacity" />
                                            <ThumbsDown className="w-3.5 h-3.5 cursor-pointer hover:opacity-100 transition-opacity" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Quick Actions */}
                                <div className="mt-2">
                                    <p className="text-xs text-gray-400 mb-2.5 pl-1">Try asking:</p>
                    ...
                    <div className="px-3 pb-3 pt-2 flex-shrink-0 border-t border-white/5">
                        <div className="flex items-center gap-2">
                            <input
                                ...
                                disabled={isLoading}
                                className="flex-1 bg-white/5 border border-white/15 rounded-full
