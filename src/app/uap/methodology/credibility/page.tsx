    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <section className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="bg-white/5 rounded-xl border border-white/10 p-6 space-y-4 text-slate-300 leading-relaxed">
          <p>
            The <strong className="text-white">Credibility Score</strong> is a{" "}
            <strong className="text-white">0-100 composite metric</strong> assigned to each person
          ...
          <p>
            The score is <strong className="text-white">not</strong> a judgment of whether someone
            is telling the truth. It measures the{" "}
            <strong className="text-white">density of verifiable credibility indicators</strong>{" "}
          ...
          <p>
            ...
            <strong className="text-white">avg_credibility_score</strong> displayed on the Persons
      ...
      <section className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="mt-8 bg-white/5 rounded-xl border border-white/10 p-6">
          <h3 className="font-semibold text-white mb-4">Score Interpretation</h3>
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-slate-400 w-48">
      ...
      <section className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="bg-white/5 rounded-xl border border-white/10 p-6 space-y-4 text-slate-300 leading-relaxed text-sm">
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <strong className="text-white">Video Analysis</strong> — When a Tier 2 (Program/Research)
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <strong className="text-white">Per-Person Scoring</strong> — For each named person,
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <strong className="text-white">Entity Resolution</strong> — Person mentions are fuzzy-matched
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <strong className="text-white">Averaging</strong> — The canonical person profile&apos;s
                displayed score is the <strong className="text-white">average</strong> of all per-video
      ...
      <section className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="bg-emerald-500/5 rounded-xl border border-emerald-500/20 p-6 space-y-3 text-sm text-slate-300 leading-relaxed">
          <div className="flex items-start gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 mt-1.5 shrink-0" />
            <span>
              <strong className="text-white">Consistent application</strong> — Every person is evaluated
          ...
          <div className="flex items-start gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 mt-1.5 shrink-0" />
            <span>
              <strong className="text-white">Evidence-anchored</strong> — The rubric is grounded in
          ...
          <div className="flex items-start gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 mt-1.5 shrink-0" />
            <span>
              <strong className="text-white">Multi-source averaging</strong> — Scores improve with
          ...
          <div className="flex items-start gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 mt-1.5 shrink-0" />
            <span>
              <strong className="text-white">Transparent rubric</strong> — The exact factors and point
          ...
          <div className="flex items-start gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 mt-1.5 shrink-0" />
            <span>
              <strong className="text-white">Scalable</strong> — The same analysis has been applied
      ...
      <section className="max-w-4xl mx-auto px-4 py-10">
        ...
        <div className="bg-red-500/5 rounded-xl border border-red-500/20 p-6 space-y-3 text-sm text-slate-300 leading-relaxed">
          <div className="flex items-start gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-red-400 mt-1.5 shrink-0" />
            <span>
              <strong className="text-white">Transcript-dependent</strong> — The AI can only score
          ...
          <div className="flex items-start gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-red-400 mt-1.5 shrink-0" />
            <span>
              <strong className="text-white">Not a truth detector</strong> — A high credibility score
          ...
          <div className="flex items-start gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-red-400 mt-1.5 shrink-0" />
            <span>
              <strong className="text-white">AI interpretation errors</strong> — GPT-4o-mini may
          ...
          <div className="flex items-start gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-red-400 mt-1.5 shrink-0" />
            <span>
              <strong className="text-white">Institutional bias in rubric design</strong> — The
          ...
          <div className="flex items-start gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-red-400 mt-1.5 shrink-0" />
            <span>
              <strong className="text-white">Video selection bias</strong> — The score reflects what
          ...
          <div className="flex items-start gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-red-400 mt-1.5 shrink-0" />
            <span>
              <strong className="text-white">No cross-verification</strong> — The AI does not
      ...
      <section className="max-w-4xl mx-auto px-4 py-10 pb-20">
        <div className="bg-white/5 rounded-xl border border-white/10 p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4">
          <div className="flex-1">
            <h3 className="font-semibold text-white mb-1">Explore Persons of Interest</h3>
