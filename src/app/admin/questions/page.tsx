    ...
    return (
        <div className="p-6 max-w-5xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">User Questions</h1>
            ...
            {/* Filter tabs */}
            <div className="flex gap-1 mb-4 bg-slate-100 dark:bg-white/10 p-1 rounded-lg w-fit">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-3 max-w-xs">
                                            <p className="font-medium text-slate-800 dark:text-slate-200 truncate" title={q.question}>
                                                {q.question}
                                            </p>
                                            {synthesis && (
                                        ...
                                        <td className="px-4 py-3">
                                            <div className="flex items-center gap-2 justify-end">
                                                <Link
                                                    ...
                                                    target="_blank"
                                                    className="p-1.5 rounded text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-white/10 transition-colors"
