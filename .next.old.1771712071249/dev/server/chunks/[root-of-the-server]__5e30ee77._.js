 ...
 * 
 * Why this exists: Running all 5 analysis passes costs ~$0.02-0.05 per video
...
async function classifyExperience(transcript) {
    ...
    try {
        ...
        const completion = await openai.chat.completions.create({
            ...
            messages: [
                ...
                {
                    role: 'user',
                    content: `Classify this video transcript:\n\n${truncated}`
                }
            ],
            response_format: {
                type: 'json_object'
 ...
 * 6. Run full analysis suite (5 passes in parallel)
...
async function processVideoIntake(youtubeUrl, onStep) {
    ...
    try {
        ...
        const classification = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Antigravity$2f$ProjectProfound$2f$profound$2d$archive$2f$src$2f$lib$2f$ai$2f$classify$2d$experience$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["classifyExperience"])(transcripts.punctuated);
        if (!classification) {
        ...
        logStep('Full Analysis', 'running', 'Running 5 analysis passes in parallel...');
        await updateIntakeStatus(supabase, videoId, 'analyzing');
        const [greysonResult, transformResult, coreResult, phenResult, journeyResult] = await Promise.allSettled([
        ...
        logStep('Save Analysis', 'success', 'All passes saved to nde_analysis', Date.now() - startSave);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5e30ee77._.js.map