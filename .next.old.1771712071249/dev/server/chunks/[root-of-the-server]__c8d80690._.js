...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Antigravity$2f$ProjectProfound$2f$profound$2d$archive$2f$node_modules$2f$openai$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/Documents/Antigravity/ProjectProfound/profound-archive/node_modules/openai/index.mjs [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Antigravity$2f$ProjectProfound$2f$profound$2d$archive$2f$node_modules$2f$openai$2f$client$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__OpenAI__as__default$3e$__ = __turbopack_context__.i("[project]/Documents/Antigravity/ProjectProfound/profound-archive/node_modules/openai/client.mjs [app-route] (ecmascript) <export OpenAI as default>");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Antigravity$2f$ProjectProfound$2f$profound$2d$archive$2f$node_modules$2f$typesense$2f$lib$2f$Typesense$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/Antigravity/ProjectProfound/profound-archive/node_modules/typesense/lib/Typesense.js [app-route] (ecmascript)");
...
async function generateEmbeddings(supabase, videoId, transcripts) {
    ...
    if (transcripts.searchChunks.length > 0) {
        ...
        for(let i = 0; i < searchRows.length; i += BATCH_SIZE){
            ...
            const { error: searchError } = await supabase.from('nde_punctuated_embeddings').insert(batch);
            if (searchError) {
    ...
    if (transcripts.chatChunks.length > 0) {
        ...
        for(let i = 0; i < chatRows.length; i += BATCH_SIZE){
            ...
            const { error: chatError } = await supabase.from('nde_chatbot_chunks').insert(batch);
            if (chatError) {
 ...
 */ async function syncToTypesense(supabase, videoId, metadata, transcripts) {
    ...
    try {
        const typesense = new __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Antigravity$2f$ProjectProfound$2f$profound$2d$archive$2f$node_modules$2f$typesense$2f$lib$2f$Typesense$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].Client({
            nodes: [
                {
                    host,
                    port,
        ...
        const { data: video } = await supabase.from('nde_vids').select('videoId, title, url, thumbnailUrl, date, viewCount, channelName, isNde').eq('videoId', videoId).single();
        ...
        const results = await typesense.collections('videos').documents().import(documents, {
            action: 'upsert',
            batch_size: 500
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c8d80690._.js.map